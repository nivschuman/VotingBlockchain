...
func TestTransactionValidInActiveChain_WhenTransactionIsInvalid(t *testing.T) {
	...
	isValid, err := inits.TestTransactionRepository.TransactionValidInActiveChain(tx)
...
func TestTransactionsValidInChain_WhenTransactionsAreValid(t *testing.T) {
	...
	isValid, err := inits.TestTransactionRepository.TransactionsValidInChain(blocks[0].Header.Id, txs)
...
func TestGetMissingTransactionIds(t *testing.T) {
	...
	missing, err := inits.TestTransactionRepository.GetMissingTransactionIds(ids)
